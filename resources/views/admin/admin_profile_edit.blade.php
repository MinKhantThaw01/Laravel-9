                ...
                <div class="card">
                    ...
                    <form action="{{ route('store.profile') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <img id="showImage" class="rounded avatar-lg" src="{{ (!empty($editData->profile_image)?url('upload/profileImage/'.$editData->profile_image):url('upload/no_image.jpg'))}}" alt="Card image cap">     
                            </div>
                        </div>
